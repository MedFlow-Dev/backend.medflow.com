...
/**
  ...
  $extends: $Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<ClientOptions>, ExtArgs, $Utils.Call<Prisma.TypeMapCb<ClientOptions>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.appointment`: Exposes CRUD operations for the **Appointement** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Appointements
    * const appointements = await prisma.appointment.findMany()
...
export namespace Prisma {
  ...
  */
  ...
  export interface AppointementDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const appointements = await prisma.appointment.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const appointementWithIdOnly = await prisma.appointment.findMany({ select: { id: true } })
     * 
     */
     ...
     * const Appointement = await prisma.appointment.create({
     *   data: {
     ...
     * const appointementWithIdOnly = await prisma.appointment.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const Appointement = await prisma.appointment.delete({
     *   where: {
     ...
     * const appointementWithIdOnly = await prisma.appointment.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "picture" | "firstname" | "lastname" | "email" | "gender" | "password" | "access_token" | "phone_number" | "role_id" | "clinic_id" | "created_at" | "updated_at", ExtArgs["result"]["user"]>
